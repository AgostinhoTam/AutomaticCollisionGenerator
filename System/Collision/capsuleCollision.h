...
カプセルコリジョン処理(capsuleCollision.h)
...
public:
	CapsuleCollision(const std::string& CollisionName,const XMFLOAT3& StartPosition, const XMFLOAT3& Offset, float Radius);	// 引数（Ownerポインタ、Offset値、半径、高さ）
